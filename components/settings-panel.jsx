...
export function SettingsPanel({ open, onClose, settings, onSettingsChange, onClearHistory, hasHistory }) {
  ...
  return (
    <div className="absolute inset-0 z-50 flex">
      ...
      {/* Clear-history confirmation — centered modal over the whole window */}
      {confirmClear && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-sm rounded-lg border border-border bg-background shadow-2xl p-5" role="dialog" aria-modal="true">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-semibold text-fg">Clear conversation?</h3>
            </div>
            <p className="text-sm text-muted-foreground mb-4">
              This deletes the entire conversation and starts fresh. It can't be undone.
            </p>
            <div className="flex items-center gap-2 justify-end">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-md bg-wrong-text text-white hover:opacity-90 transition-opacity"
              >
                <Trash2 className="h-4 w-4" />
                Clear
              </button>
